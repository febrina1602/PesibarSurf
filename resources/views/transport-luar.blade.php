    ...
    <div class="marketplace-header-img">
        <div class="w-100 text-center mb-3">
            <div class="marketplace-title">
                <span class="d-block">Transportasi Luar</span>
            </div>
        </div>
    </div>

    {{-- LIST KATEGORI TRANSPORTASI LUAR --}}
...
{{-- ================== MODAL LUAR – AGEN SEWA MOBIL ================== --}}
<div class="modal fade" id="modalLuarAgenMobil" tabindex="-1" aria-hidden="true">
                                ...
                                <div class="card h-100 shadow-sm border-0" style="border-radius:16px;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <button
                                            ...
                                            data-location="Bandar Lampung"
                                            data-rating="5.0"
                                            data-agency="Agensi Luar Daerah"
...
{{-- ================== MODAL LUAR – AGEN SEWA MOTOR ================== --}}
<div class="modal fade" id="modalLuarAgenMotor" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content border-0 rounded-4 overflow-hidden">
            ...
            <div class="marketplace-header-img" style="height:120px;">
                <div class="w-100 text-center mb-3">
                    <div class="marketplace-title">
                        ...
                        <span class="d-block">Pemesanan Bus</span>
                    </div>
                </div>
...
{{-- =============== MODAL DETAIL AGEN (SAMA, DIPAKAI SEMUA) =============== --}}
