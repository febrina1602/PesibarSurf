...
@section('title','Masuk - PesibarSurf')

@push('styles')
<style>
  /* Khusus halaman login */
  .auth-wrapper{ max-width:1180px; margin:28px auto; background:#fff; border-radius:18px; box-shadow:0 12px 30px rgba(0,0,0,.08); overflow:hidden; }
  .topbar{ height:70px; background:linear-gradient(90deg,#FFD15C 0%,#FF9739 45%,#FF3D3D 100%); display:flex; align-items:center; padding:0 22px; }
  ...
  /* Class 'form-control' di sini akan menimpa 'form-control' global HANYA di halaman ini */
  .auth-wrapper .form-control{ height:46px; border-radius:10px; padding-right:42px; } 
  .input-icon-btn{ position:absolute; right:12px; top:50%; transform:translateY(-50%); opacity:.6; }
  .btn-grad{ background:linear-gradient(90deg,#FFD15C 0%,#FF9739 45%,#FF3D3D 100%); color:#fff; border:none; height:46px; border-radius:12px; font-weight:700; }
